...
// estrategia de generacion izquierda: los objetos vienen desde la derecha
public class EstrategiaGeneracionIzquierda implements EstrategiaGeneracion {
    
    @Override
    public ObjetoCayendo generarObjeto(GestorDeRecursos recursos) {
        float y = MathUtils.random(0, 480 - 64);
        float x = 800; // viene desde la derecha de la pantalla
        ...
        // reorientamos el objeto para que vaya hacia la izquierda
        objeto.reorientar(GameScreen.EstadoJuego.GRAVEDAD_IZQUIERDA);
        return objeto;
    }
}